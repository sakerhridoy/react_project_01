      ...
      <section className="pt-16 md:pt-24 xl:pt-[171px] pb-16 md:pb-24 xl:pb-[149px]">
        <div className="container bg-[#E0FFF9] py-10 md:py-[86px] ps-[50px] pe-[37px] rounded-[20px] px-4 xl:px-0.5 2xl:px-0">
          <div className="md:flex md:gap-11 xl:gap-[124px]">
            ...
            <div className="w-full md:w-4/6 flex justify-between">
              <div className="pt-6 md:pt-0">
                <h2
                  id="customer"
                  className="font-inter font-bold text-4xl md:text-[50px] text-[#151515]"
                >
                  <CountUp end={200} duration={3.5} />+{/* 200 */}
                </h2>
                <p className="font-inter font-medium text-[#737373] text-base md:text-[20px] pt-5">
                  Customer Satisfied
                </p>
              </div>
              <div className="pt-6 md:pt-0">
                <h2 className="font-inter font-bold text-4xl md:text-[50px] text-[#151515]">
                  <CountUp end={4.5} duration={2.5} decimals={1} />
                </h2>
                <p className="font-inter font-medium text-[#737373] text-base md:text-[20px] pt-5">
                  <CountUp end={200} duration={2.5} />+ Avg rating
                </p>
              </div>
              <div className="pt-6 md:pt-0">
                <h2 className="font-inter font-bold text-4xl md:text-[50px] text-[#151515]">
